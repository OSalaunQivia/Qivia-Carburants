...
def generate_carte(stations_with_prices, template_path="qivia_carte_template.html", output_path="qivia_carte.html"):
    ...
    def _addr_key(address, postal):
        ...
        return f"{postal}_{_normalize(address)}"
    ...
    # ================================================================
    # ÉTAPE 5: Filtrer les stations sans coordonnées et injecter
    # ================================================================
    all_stations = [s for s in stations_map.values() if s.get("lat") and s.get("lon")]
    print(f"[Carte] Stations avec coordonnées: {len(all_stations)}")
